...
const CHAPTERS = [
  ...
  "NIT Rourkela Chapter",
  "NIT Surathkal Chapter",
  "NIT Jaipur Chapter",
  "NIT Durgapur Chapter",
  "NIT Silchar Chapter",
  "NIT Kurukshetra Chapter",
  // IIITs
  "IIIT Gwalior Chapter",
  "IIIT Hyderabad Chapter",
  "IIIT Allahabad Chapter",
  "IIIT Delhi Chapter",
  "IIIT Bangalore Chapter",
  "IIIT Bhagalpur Chapter",
  "IIIT Sonepat Chapter",
  // Deemed / Private
  "MIT Manipal Chapter",
  "BITS Patna Chapter",
  "BITS Goa Chapter",
  "BITS Hyderabad Chapter",
  "KIIT Bhubaneswar Chapter",
  "VIT Vellore Chapter",
  "SRM Chennai Chapter",
  "Thapar University Chapter",
  "DTU Delhi Chapter",
  "NSUT Delhi Chapter",
  "COEP Pune Chapter",
  "VJTI Mumbai Chapter",
  "BMSCE Bangalore Chapter",
  "PES University Chapter",
  "Amity Noida Chapter",
  "LPU Phagwara Chapter",
  "Chandigarh University Chapter",
  "SASTRA Deemed University Chapter",
  "Vignan's Institute of Information Technology Chapter",
  // New colleges
  "Amity University Lucknow Chapter",
  "Asansol Engineering College Chapter",
  "Babu Banarsi Das Institute of Technology and Management Chapter",
  "BIT Mesra Patna Chapter",
  "DY Patil Agriculture and Technical University Chapter",
  "Fr. C. Rodrigues Institute of Technology Chapter",
  "G.H. Raisoni College of Engineering Pune Chapter",
  "Government Engineering College Jehanabad Chapter",
  "Government Engineering College Patan Chapter",
  "Gyan Ganga Institute of Technology and Sciences Chapter",
  "Haldia Institute of Technology Chapter",
  "Institute of Engineering and Management Kolkata Chapter",
  "KIIT Chapter",
  "Khwaza Moinudin Chisti Language University Chapter",
  "KIET Group of Institutions Chapter",
  "KLE Technological University Chapter",
  "LBS Institute of Technology for Women Chapter",
  "MET Institute of Technology Chapter",
  "MRU College Chapter",
  "Panjab University SSGRC Chapter",
  "S B Jain Institute of Technology Management and Research Chapter",
  "Saharsa College of Engineering Chapter",
  "Samrat Ashok Technological Institute Chapter",
  "Sandip Institute of Technology and Research Center Chapter",
  "Shri G.S. Institute of Technology & Science Chapter",
  "Shri Ramswaroop Memorial College of Engineering Chapter",
  "University of Lucknow Chapter",
  "UPL University of Sustainable Technology Chapter",
  "Vignan Institute of Engineering for Women Chapter",
];
